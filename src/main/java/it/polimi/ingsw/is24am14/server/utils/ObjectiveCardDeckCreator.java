...
public class ObjectiveCardDeckCreator {
    ...
    public Deck<ObjectiveCard> createObjectiveCardDeck() {
        ...
        content.add(new ObjectiveCard(redDiag, "src/main/resources/images/cards/objective_cards/objective_fronts/page_87.png", "src/main/resources/images/cards/resource_cards/objective_backs/page_87.png", 2));
        ...
        content.add(new ObjectiveCard(greenDiag, "src/main/resources/images/cards/objective_cards/objective_fronts/page_88.png", "src/main/resources/images/cards/resource_cards/objective_backs/page_88.png", 2));
        ...
        content.add(new ObjectiveCard(blueDiag, "src/main/resources/images/cards/objective_cards/objective_fronts/page_89.png", "src/main/resources/images/cards/resource_cards/objective_backs/page_89.png", 2));
        ...
        content.add(new ObjectiveCard(purpleDiag, "src/main/resources/images/cards/objective_cards/objective_fronts/page_90.png", "src/main/resources/images/cards/resource_cards/objective_backs/page_90.png", 2));
        ...
        content.add(new ObjectiveCard(redRedGreenL, "src/main/resources/images/cards/objective_cards/objective_fronts/page_91.png", "src/main/resources/images/cards/resource_cards/objective_backs/page_91.png", 3));
        ...
        content.add(new ObjectiveCard(greenGreenPurpleL, "src/main/resources/images/cards/objective_cards/objective_fronts/page_92.png", "src/main/resources/images/cards/resource_cards/objective_backs/page_92.png", 3));
        ...
        content.add(new ObjectiveCard(redBlueBlueL, "src/main/resources/images/cards/objective_cards/objective_fronts/page_93.png", "src/main/resources/images/cards/resource_cards/objective_backs/page_93.png", 3));
        ...
        content.add(new ObjectiveCard(bluePurplePurpleL, "src/main/resources/images/cards/objective_cards/objective_fronts/page_94.png", "src/main/resources/images/cards/resource_cards/objective_backs/page_94.png", 3));
        ...
        threeFungi.addClause(CornerEnum.ResourceEnum.FUNGI);
        threeFungi.addClause(CornerEnum.ResourceEnum.FUNGI);
        content.add(new ObjectiveCard(threeFungi, "src/main/resources/images/cards/objective_cards/objective_fronts/page_95.png", "src/main/resources/images/cards/resource_cards/objective_backs/page_95.png", 2));
        ...
        threePlant.addClause(CornerEnum.ResourceEnum.PLANT);
        threePlant.addClause(CornerEnum.ResourceEnum.PLANT);
        content.add(new ObjectiveCard(threePlant, "src/main/resources/images/cards/objective_cards/objective_fronts/page_96.png", "src/main/resources/images/cards/resource_cards/objective_backs/page_96.png", 2));

        ResourceCondition threeAnimal = new ResourceCondition();
        threeAnimal.addClause(CornerEnum.ResourceEnum.ANIMAL);
        threeAnimal.addClause(CornerEnum.ResourceEnum.ANIMAL);
        threeAnimal.addClause(CornerEnum.ResourceEnum.ANIMAL);
        content.add(new ObjectiveCard(threeAnimal, "src/main/resources/images/cards/objective_cards/objective_fronts/page_97.png", "src/main/resources/images/cards/resource_cards/objective_backs/page_97.png", 2));

        ResourceCondition threeInsect = new ResourceCondition();
        threeInsect.addClause(CornerEnum.ResourceEnum.INSECT);
        threeInsect.addClause(CornerEnum.ResourceEnum.INSECT);
        threeInsect.addClause(CornerEnum.ResourceEnum.INSECT);
        content.add(new ObjectiveCard(threeInsect, "src/main/resources/images/cards/objective_cards/objective_fronts/page_98.png", "src/main/resources/images/cards/resource_cards/objective_backs/page_98.png", 2));
        ...
        content.add(new ObjectiveCard(quiInkMan,"src/main/resources/images/cards/objective_cards/objective_fronts/page_99.png", "src/main/resources/images/cards/resource_cards/objective_backs/page_99.png", 3));

        ObjectCondition twoMan = new ObjectCondition();
        twoMan.addClause(CornerEnum.ObjectEnum.MANUSCRIPT);
        twoMan.addClause(CornerEnum.ObjectEnum.MANUSCRIPT);
        content.add(new ObjectiveCard(twoMan,"src/main/resources/images/cards/objective_cards/objective_fronts/page_100.png", "src/main/resources/images/cards/resource_cards/objective_backs/page_100.png", 2));

        ObjectCondition twoInk = new ObjectCondition();
        twoInk.addClause(CornerEnum.ObjectEnum.INKWELL);
        twoInk.addClause(CornerEnum.ObjectEnum.INKWELL);
        content.add(new ObjectiveCard(twoInk,"src/main/resources/images/cards/objective_cards/objective_fronts/page_101.png", "src/main/resources/images/cards/resource_cards/objective_backs/page_101.png", 2));

        ObjectCondition twoQui = new ObjectCondition();
        twoQui.addClause(CornerEnum.ObjectEnum.QUILL);
        twoQui.addClause(CornerEnum.ObjectEnum.QUILL);
        content.add(new ObjectiveCard(twoQui,"src/main/resources/images/cards/objective_cards/objective_fronts/page_102.png", "src/main/resources/images/cards/resource_cards/objective_backs/page_102.png", 2));
